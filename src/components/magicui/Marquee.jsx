...
// Simple marquee inspired by Magic UI (JS version)
      ...
      {Array.from({ length: repeat }).map((_, i) => (
        <div
          ...
          className={cn(
            ...
            vertical ? "animate-marquee-vertical flex-col" : reverse ? "animate-marquee-reverse flex-row" : "animate-marquee flex-row",
