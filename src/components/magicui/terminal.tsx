...
export const TypingAnimation = ({ children, className, duration = 60, delay = 0, as: Component = "span", startOnView = true, ...props }: TypingAnimationProps) => {
...
export const Terminal = ({ children, className, sequence = true, startOnView = true }: TerminalProps) => {
  ...
  const content = (
    <div ref={containerRef} className={cn("z-0 h-full max-h-[400px] w-full max-w-lg rounded-xl border border-border bg-background", className)}>
